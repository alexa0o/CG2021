...
int main( void )
{
    ...
    GLuint shaders[] = {
            LoadShaders("SimpleTransform.vertexshader", "YellowColor.fragmentshader"),
            LoadShaders("SimpleTransform.vertexshader", "BlueColor.fragmentshader")
    };
	// Get a handle for our "MVP" uniform
	// GLuint MatrixID = glGetUniformLocation(programID, "MVP");

    GLuint MatrixIDs[] = {
            glGetUniformLocation(shaders[0], "MVP"),
            glGetUniformLocation(shaders[1], "MVP")
    };
	...
	do{
        ...
        glm::mat4 View       = glm::lookAt(
                glm::vec3(camera_x,camera_y,camera_z), // Camera is at (4,3,3), in World Space
